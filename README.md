...
![Status](https://img.shields.io/badge/Status-Learning_Project-yellow?style=for-the-badge)
...
* **Categorized Browsing:** Organized into logical modules (e.g., *Cardiac Markers*, *24h Urine Collection*).
* **Context Aware:** Different conversion factors for Urine vs Serum.
* **Educational Warnings:** Highlights complex calculations (e.g., HbA1c conversion formulas).
